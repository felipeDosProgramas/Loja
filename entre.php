    ...
    <body>
                    ...
                    <div id="navegacao">
                        ...
                        <div id="divUl">
                            <ul id="ulMenu">
                                ...
                                <li class="li" id="LogouOuNN"><a href="entre.php">Entre</a></li>
							</ul>
        ...
        <section>
            <div class="caixaForm">
                <div class="boxForm">
                    <div class="formEntre">
                        <h2 class="hCadaster">login</h2>
                        <input type="text" placeholder="Digite seu email" class="inputs" id="email">
                        <input type="text" placeholder="Digite sua senha" class="inputs" id="senha">
                        <button class="btnSub" id="butao"> Entrar </button>
						<div id="possuiContaDiv">
							não possui uma conta ? <strong><a href="cadasterUser.html">Cadastre-se</a></strong>
							<br>
