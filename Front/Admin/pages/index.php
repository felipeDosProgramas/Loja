<?php
	...
	<html lang="pt-br">
		...
		<body>
			...
			<div id="faixa">Administração</div>
			<section >
				<div class="caixaDadosUser">
					...
					<button id="btnEdiAdm">Editar</button>
				</div>
				</div>
				</div>
				
				<div id="caixaCadasters">
					<div class="boxCadaster">
						<div class="nameBoxCadaster">lançamento</div>
						<a href="./sistema-de-previa/formPrevia.php" >
						<button class="btnCadaster">
							Cadastrar lançamento
						</button>
						</a>
						<a href="./sistema-de-previa/consultarPrevia.html" >
						<button class="btnCadaster">
					...
					<div class="boxCadaster">
						<div class="nameBoxCadaster">Produtos</div>
