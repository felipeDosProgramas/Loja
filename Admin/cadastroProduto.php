<?php
	...
	<html lang="pt-br">
		...
		<body>
			...
			<div id="faixa">Cadastro de Produto</div>
			<section>
				...
				<div id="formularioProdutos">
					...
					<div id="dadosPrimarios">
						...
						<label for="description">descrição:</label><br>
							...
							<select name="classificacao" id="classificacoes" required>
								<option value="" selected hidden disabled>classificação</option>
							</select>
							
							<div id="criadorClassis">
								<button id="newClass">criar classificação</button><br>
								<button id="tiraClass">excluir classificacão</button>						
							</div>
						...
						<div id="dadosSecundarios">
							...
							<span id="tamanhos">							
								<input type="number" min="0" max="50" id="qtdTamanhos" required>
							</span>
							<br>
